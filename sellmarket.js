if (typeof localStorage === "undefined" || localStorage === null) {
  ...
  async function slowdown() {
    ...
    var dataQueryString2 = "symbol=" + localStorage['symbol'] + "BUSD&side=SELL&type=MARKET&quantity=" + localStorage['Executed'] + "&timestamp=" + Date.now(); //ค่าธรรมเนียมแก้เป็น executedfee executedfee_backup
